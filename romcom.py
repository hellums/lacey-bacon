...
import os # for calls to clear screen
import csv # to import TSV files for moive and actor lists
...
# Initialize lists from associated files of curated "Hallmark" data
movie_list = []  # title-basics-imdb.tsv
rating_list = []  # title-ratings-imdb.tsv
actor_list = []  # name-basics-imdb.tsv
role_list = []  # title-actors-imdb.tsv
...
def print_menu():
    ...
    # Validaate records loaded from file and addressable
    #print (actor_list[0].Id)
    #print (actor_list[1].Id)
